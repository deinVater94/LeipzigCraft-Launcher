...
public partial class MainWindow : Window
{
    ...
    private async void LoginButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        await RunBusyAsync(async () =>
        {
            ...
            AccountText.Text = string.IsNullOrWhiteSpace(_session.Username)
        ...
        await RunBusyAsync(async () =>
        {
            ...
            if (!_pack.HasLocalMods())
            {
                throw new InvalidOperationException(
                    ...
                    "Prüfe https://leipzigcraft.com/launcher/pack.json und die GitHub-Release-Dateien.");
            }

            var fabricRuntimeReady = _fabric.AreRuntimeFilesInstalled();
